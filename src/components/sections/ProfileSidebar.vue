<template>
  ...
  >
    ...
    <div class="text-center space-y-2 lg:space-y-4">
      <h1
        class="text-xl lg:text-2xl font-bold text-gray-800 hover:text-[var(--color-primary)] transition-colors duration-200"
      >
        {{ personalInfo.name }}
      </h1>
      ...
      <div class="pt-2 lg:pt-4 space-y-2">
        <div
          class="flex items-center justify-center space-x-2 text-xs lg:text-sm text-gray-600 hover:text-[var(--color-primary)] transition-colors duration-200"
        >
